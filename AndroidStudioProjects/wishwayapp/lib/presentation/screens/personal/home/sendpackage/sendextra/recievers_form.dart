...
import 'package:wishwayapp/presentation/screens/personal/home/sendpackage/item_details.dart';
...
class RecieverForm extends StatelessWidget {
    ...
    return Column(
      children: [
        ...
        AppButton(
            ...
            onTap: () {
              changeIndex.changeSendPackageIndex(2);
              PageRouting.pushToPage(context, const ItemDetails());
            },
            curves: 5,
            child: AppTextMulish(
              text: "Next",
