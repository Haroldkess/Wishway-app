...
class PersonalRegisterationForm extends StatelessWidget {
  const PersonalRegisterationForm({super.key});
  @override
    ...
    return Column(
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              forms(context, "Gwill Ventures", const SizedBox.shrink()),
              Row(
                children: [
                  AppTextMulish(
                    text: "Email",
        ...
        AppButton(
            ...
            onTap: () =>
                PageRouting.pushToPage(context, const DeliveryAddressScreen()),
            curves: 5,
            child: AppTextMulish(
              text: "Next",
              color: textLightColor,
