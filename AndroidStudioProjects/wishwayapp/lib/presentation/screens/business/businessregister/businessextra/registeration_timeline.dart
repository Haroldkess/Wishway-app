...
class RegistrationTimeLine extends StatefulWidget {
  @override
  _RegistrationTimeLineState createState() => _RegistrationTimeLineState();
}
      ...
      child: Timeline.tileBuilder(
        ...
        builder: TimelineTileBuilder.connected(
            ...
            if (index == 0) {
              return Stack(
                children: [
                  ...
                  DotIndicator(
                    size: 30.0,
                    color: streamIndex.trackRegTimeline.contains(index)
                        ? primaryOrange
                        : HexColor("#242830"),
                    child: Center(
                      child: AppTextOverPass(
          ...
          connectorBuilder: (_, index, type) {
            if (streamIndex.regTimelineIndex == 0) {
              return DottedLine(
                dashColor: HexColor("#242830"),
              );
            } else if (streamIndex.regTimelineIndex == 1 && index == 1) {
              return DottedLine(
                // dashLength: 5,
                dashGapLength: 1,
                lineThickness: 1,
            ...
            } else if (streamIndex.regTimelineIndex == 2 && index == 2) {
              return DottedLine(
                dashColor: primaryOrange,
                dashGapLength: 1,
                lineThickness: 1,
              ...
              return DottedLine(
                dashColor: streamIndex.regTimelineIndex == 2
                    ? primaryOrange
                    : HexColor("#242830"),
                dashGapLength: streamIndex.regTimelineIndex == 2 ? 1 : 4.0,
                lineThickness: streamIndex.regTimelineIndex == 2 ? 1 : 1,
              );
            }
          },
